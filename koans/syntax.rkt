...
;
; After reading, Racket _expands_ this syntax object into a well-formed program.
; (well-formed = no unbound identifiers, no single-armed `if` statements, etc.)
;
; And after expanding, Racket runs the program. (The expander is a program that
; runs to produce the program you originally wanted to run.)
;
